...
//  KPSSPuanHesaplama
//
//  Created by Enes Babacan on 20.08.2024.
//
        ...
        NavigationStack {
            VStack {
                List {
                    ...
                    Section {
                        Text("2022 P3(Memur): \(sonuc2023, specifier: "%.3f")")
                        Text("2022 P10(Öğretmen): \(sonucEB2023, specifier: "%.3f")")
                            if sonucOABT2022 != nil {
                                Text("2022 P121(Alan): \(sonucOABT2023 ?? 0, specifier: "%.3f")")
                    }
